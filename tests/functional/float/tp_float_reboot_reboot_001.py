...
#
# ID:
#       functional/float/tp_float_reboot_reboot_001
#
# DESCRIPTION:
#       Reboot two root domains simutaneously, IO domain with two VFs configured
...
#   	- Reboot root domains NPRD1 and NPRD2 by 'reboot'in NPRD1 and NPRD2.
